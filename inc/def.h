...
#define     N_FUNCTIONS			128		// Number of Functions per generation
#define     N_PARENTS			8		// Number of parents to pick
...
#define		PERC_INHERIT		65		// Chance of child taking over data from parent B
